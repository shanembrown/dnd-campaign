...
- **Current Location**: Leaving **[Palewater](locations/palewater.md)** (salt-harvesting town on Forden) for **Crusivar** aboard The Thornbill. The silencing was resolved — see below. The party took a **long rest** at session end (HP, slots, abilities refreshed)
...
## Recent Events (current session) — Palewater: Garrow, the Two Rites, the Breaking
...
- **The flood cut it short.** The climbing tide **broke in over the pans**, forcing the party to abandon the ritual unfinished. Most souls released, but **~23 did not make it out** — fate unknown. **Garrow himself was lost** in the flood — **not confirmed dead; could resurface.** A partial success at real cost.
- **Open threads:** **Garrow's fate** · the **~23** · the **first 12 + stone substance** (never examined — released or lost?) · **restoration vs. release UNCONFIRMED** (freed souls said "I am released" and vanished; the party skipped recovering anchor-objects to beat the tide, so it's unknown whether living people were *restored* or souls merely *released to peace*) · **who handed Garrow the corrupted rite** · the **[salt man](npcs/the-salt-man.md)** · **E. G. "who burned"** · the **[grey cat](npcs/the-grey-cat.md)**.
