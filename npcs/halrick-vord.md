...
> Name spelling unconfirmed ("Halrick Vord").

## Status
A **former Brother of [The Avowed](factions/the-avowed.md)** who left the order and now resides in **[Crusivar](locations/crusivar.md)** on [Forden](locations/forden.md).

## Description
A onetime Avowed Brother who **departed the order many years ago** and traveled south. **[Brother Ennic](npcs/brother-ennic.md)** directed the party to seek him out in Crusivar, sending them with his introduction ("Ennic sent us").

## Connection to the Party
- The party carries his **ornate brass key** (identified by [Hazik](pcs/hazik.md)) — **attuned to Vord**, paired to a **magical lock somewhere**. Returning it is a natural opener with him.
